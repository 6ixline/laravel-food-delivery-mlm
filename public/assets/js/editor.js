...
$(document).ready(function(){
	...
	var image_model2 = $('#image_model2');

	// Get the button that opens the modal
	var image_model_button2 = $("#image_model_button2");
	
	// Get the <span> element that closes the modal
	var image_close_button2 = $(".image_close_button2");

	var image_close2 = $('#image_close2');
	
	image_model_button2.click(function(){
		image_model2.fadeIn(100);
		/*modal.animate({ fontSize: '15px' });*/
	});

	image_close_button2.click(function(){
		image_model2.fadeOut(100);
	});

	image_close2.click(function(){
		image_model2.fadeOut(100);
	});
});
