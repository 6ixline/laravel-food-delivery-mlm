							...
							<div class="blog-single dz-card sidebar">
								...
								<div class="dz-info">
									...
									<div class="dz-post-text">
										...
										<p>At example, your privacy is our priority. This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you use our mobile app, website, and related services (collectively, the “Service”).</p>
										<p>By using example, you consent to the practices described in this Privacy Policy.</p>
										...
										<ul>
											...
											<li>
												<p><strong>Company</strong> (referred to as either &quot;the
													...
													this Agreement) refers to K3 Khana.</p>
											</li>
											<li>
											...
											<li>
												<p><strong>Third-party Social Media Service</strong> refers to any
													...
													in or create an account to use the Service.</p>
											</li>
											<li>
											...
											<li>
												<p><strong>Website</strong> refers to K3 Khana, accessible from <a
														href="http://www.example.com" rel="external nofollow noopener"
														target="_blank">http://www.example.com</a></p>
											</li>
											<li>
